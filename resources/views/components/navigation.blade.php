    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <nav class="hidden md:flex space-x-10">
                ...
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Turismo </a>
                {{-- <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Servicios </a> --}}
                {{-- <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Transparencia </a> --}}
                {{-- <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Turismo </a> --}}
